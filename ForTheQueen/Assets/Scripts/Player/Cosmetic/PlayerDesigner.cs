...
public class PlayerDesigner : MonoBehaviourPun
{
    ...
    public List<EquipableItem> hats;
    public List<EquipableItem> hair;
    public List<EquipableItem> beards;
    public List<EquipableItem> other;
    ...
    protected IEnumerable<KeyValuePair<string, List<EquipableItem>>> GetItemLists()
    {
    ...
    public void StartDesigner(bool display)
    {
        ...
        int index = 0;
        foreach(KeyValuePair<string,List<EquipableItem>> items in GetItemLists())
        {
