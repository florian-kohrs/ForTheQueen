...
public class ListSelection : MonoBehaviour
{
    ...
    protected List<EquipableItem> availableItems;
    ...
    public void Initialize(Vector2 localPos, string displayName, List<EquipableItem> items, Transform equipParent, Action onDesignChanged)
    {
    ...
    protected void EquipItem()
    {
        ...
        if (index >= 0)
        {
            equippedItem = availableItems[index].CreateInstance(itemParent);
        }
    }
